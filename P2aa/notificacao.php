...
function enviarNotificacaoLogin($usuario) {
    ...
    try {
        ...
        $mail->setFrom('marcos.sousa12@fatec.sp.gov.br', 'Sistema de Login');  //marcos.sousa12@fatec.sp.gov.br
        $mail->addAddress('marcos.sousa12@fatec.sp.gov.br', 'Admin do Sistema'); 
